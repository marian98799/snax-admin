    ...
    return <div>
        ...
        <Row>
            ...
            <Col md="12">
                <Card>
                    <CardTitle className="bg-light border-bottom p-3 mb-0">
                        <i className="mdi mdi-book mr-2"></i> Form
                    </CardTitle>
                    <CardBody>
                        <Form onSubmit={handleSubmit()}>
                        <FormGroup>
                            <Row>
                                <Label sm="2" htmlFor="id">ID</Label>
                                <Col sm="10">
                                    <Input type="number" name="id"  ref={register({ required: true })} />
                                </Col>
                                <span className="text-danger">{errors.id && 'Id is required.'}</span>
                            </Row>
                        </FormGroup>
                        <FormGroup>
                            <Row>
                        ...
                        <FormGroup>
                            <Row>
                                ...
                                <Col sm="10">
                                    <Input type="text" defaultValue="" ref={register({ required: true })}/>
                                </Col>
                            </Row>
                        </FormGroup>
                        <FormGroup>
                            <Row>
                                <Label sm="2">Locked</Label>
                                <Col sm="10">
                                    <Input type="select" name="Select Category" ref={register({ required: true })}>
                                        <option></option>
                                        <option>Yes</option>
                                        <option>No</option>
                                    </Input>
                        ...
                        <FormGroup>
                            <Row>
                                <Label sm="2">Color template</Label>
                                <Col sm="10">
                                    <Input type="color" defaultValue="#563d7c" ref={register({ required: true })}/>
                                </Col>
                            </Row>
                        </FormGroup>
                        <FormGroup>
                            <Row>
                                <Label sm="2">Coins balance</Label>
                                <Col sm="10">
                                    <Input type="select" name="Select Category" ref={register({ required: true })}>
                                        <option></option>
                                        <option>No</option>
            ...
            {/*                <InputGroup>*/}
            {/*                    <InputGroupButtonDropdown addonType="prepend" isOpen={dropdownOpen} toggle={toggleDropDown.bind(null)}>*/}
            ...
            {/*                    </InputGroupButtonDropdown>*/}
            {/*                    <Input placeholder="" />*/}
            {/*                    <InputGroupButtonDropdown addonType="append" isOpen={dropdownOpen1} toggle={toggleDropDown1.bind(null)}>*/}
            {/*                        <DropdownToggle caret>*/}
            {/*                            Dropdown*/}
            {/*                </DropdownToggle>*/}
            {/*                        <DropdownMenu>*/}
